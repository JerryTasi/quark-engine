...
const behaviorNode = joint.dia.Element.define('example.form', {
    ...
    <foreignObject @selector="foreignObject">
        <div xmlns="http://www.w3.org/1999/xhtml" class="outer" >
            ...
            <div @selector="card" class="card expanded">
                ...
                <div class="card-content">
                    ...
                    <input type="text" name="firstAPI" autocomplete="off" placeholder="Input API full name"/>
                    <label class="card-label">Second API of behavior</label>
                    <input type="text" name="secondAPI" autocomplete="off" placeholder="Input API full name"/>
                    <button onclick="behaviorEditSubmit(this.parentNode)">Save</button>
                </div>
            </div>
...
const normalNode = joint.dia.Element.define('example.form', {
    attrs: {
        foreignObject: {
            width: 'calc(w)',
            height: 'calc(h)'
    ...
    <foreignObject @selector="foreignObject">
        <div xmlns="http://www.w3.org/1999/xhtml" class="outer" >
            ...
            <div @selector="card" class="card expanded">
                ...
                <button class="expand-button">+</button>
                <div class="card-content">
                    <label @selector="cardContent" class="card-label"></label>
                </div>
            </div>
